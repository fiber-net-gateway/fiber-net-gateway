 ...
 */
public final class TestedNioEventLoop extends SingleThreadEventLoop {
    ...
    TestedNioEventLoop(NioEventLoopGroup parent, Executor executor, SelectorProvider selectorProvider,
    ...
    public boolean hasScheduleTask() {
        return nextScheduledTaskNano() >= 0;
    }

    private long maxDeadlineNano;

    @Override
    protected void validateScheduled(long amount, TimeUnit unit) {
        maxDeadlineNano = Long.max(getCurrentTimeNanos(), unit.toNanos(amount));
    }

    public long getMaxTaskNanoDelay() {
        return Long.max(100L, maxDeadlineNano - getCurrentTimeNanos());
    }
