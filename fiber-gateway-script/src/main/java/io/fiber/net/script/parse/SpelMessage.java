...
public enum SpelMessage {
    ...
    OPERATOR_NOT_SUPPORTED_UNARY(Kind.ERROR, 1030, "The operator ''{0}'' is not supported between objects of type ''{1}''"),
    ...
    MISSING_INLINE_OBJECT_ELEMENT(Kind.ERROR, 1072, "the inline object key or value is missing"),
    NOT_SUPPORT_INLINE_OBJECT_KEY(Kind.ERROR, 1073, "the inline object key ''{0}''is not supported"),
    INLINE_OBJECT_DUPLICATE_KEY(Kind.ERROR, 1074, "the inline object key ''{0}'' is duplicate"),
     ...
     */
    public String formatMessagePos(int pos, Object... inserts) {
    ...
    public static String error(SpelMessage message, String flag) {
        return message.kind + "# " + message.code + " #" + message.message + ":" + flag;
    }
