...
public class ConnectionFactoryImpl implements ConnectionFactory {
    ...
    private final io.fiber.net.http.util.ChannelConfig channelConfig;
    ...
    public ConnectionFactoryImpl(EventLoopGroup group, io.fiber.net.http.util.ChannelConfig channelConfig) {
        this.group = group;
